    ...
    <div id="page-content-wrapper">
      ...
      <form class="container flex-column mt-5 ms-2" style="width: 100%;" method="post">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="email" placeholder="@gmail.com" required>
        </div>
        ...
        <div class="container flex-column mt-2" style="width: 100%;">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="maritalstatus" required>
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="currentaddress" placeholder="" required>
        </div>
