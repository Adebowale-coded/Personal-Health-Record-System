      ...
      <form class="container flex-column mt-5 ms-2" style="width: 100%;" method="post">
        ...
        <div class="mb-3 row">
          <div class="col">
            ...
            <input type="text" class="form-control" name="#" value="<?php echo $id ?>" required disabled>
          </div>
          <div class="col">
            <label class="form-label"></label>
        ...
        <div class="mb-3 row">
          ...
          <div class="col">
            <label class="form-label"></label>
            <input type="time" class="form-control" name="timeofvisit" required>
          </div>
          <div class="col">
            <label class="form-label"></label>
        ...
        <div class="mb-3 row">
          <div class="col">
            <label class="form-label"></label>
            <input type="text" class="form-control" name="bpsystolic" placeholder="BP Systolic" required>
          </div>
          <div class="col">
            <label class="form-label"></label>
            <input type="text" class="form-control" name="bpdestolic" placeholder="BP Destolic" required>
          </div>
          <div class="col">
            <label class="form-label"></label>
        ...
        <div class="mb-3 row">
          <div class="col">
            <label class="form-label"></label>
            <input type="text" class="form-control" name="respiratoryrate" placeholder="Respiratory Rate" required>
          </div>
          <div class="col">
            <label class="form-label"></label>
        ...
        <div class=" flex-column mt-3" style="width: 100%;">
          ...
          <div class="mb-3 row">
            <div class="col">
              <label class="form-label"></label>
              <input type="text" class="form-control" name="symptomname" placeholder="Symptom Name" required>
            </div>
            <div class="col">
              <label class="form-label"></label>
              <input type="text" class="form-control" name="symptom" placeholder="Symptom" required>
            </div>
          </div>
        </div>
        ...
        <div class="mb-3 row">
          <div class="col">
            <label class="form-label"></label>
            <input type="text" class="form-control" name="diagnosticsname" placeholder="Diagnostics Name" required>
          </div>
          <div class="col">
            <label class="form-label"></label>
            <input type="text" class="form-control" name="diagnostics" placeholder="Diagnostics" required>
          </div>
        </div>
        ...
        <div class="mb-3 row">
          <div class="col">
            <label class="form-label"></label>
            <input type="text" class="form-control" name="drugname" placeholder="Drug Name" required>
          </div>
          <div class="col">
            <label class="form-label"></label>
          ...
          <div class="col">
            <label class="form-label"></label>
            <input type="text" class="form-control" name="directionsforuse" placeholder="Directions for Use" required>
          </div>
          <div class="col">
            <label class="form-label"></label>
            <input type="text" class="form-control" name="quantity" placeholder="Quantity (1/2)" required>
          </div>
          <div class="col">
            <label class="form-label"></label>
            <input type="text" class="form-control" name="treatmantdetails" placeholder="Treatmant Details-" required>
          </div>
        </div>
        ...
        <div class="mb-3 row">
          <div class="col">
            <label class="form-label"></label>
            <input type="text" class="form-control" name="doctorreport" placeholder="Doctor Report" required>
          </div>
